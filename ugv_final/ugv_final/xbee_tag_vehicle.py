...
def update_telemetry():
    while True:
        ...
        if not hasattr(update_telemetry, "speed"):
            ...
            update_telemetry.current_latitude = 33.933097
            update_telemetry.current_longitude = -117.631055
            update_telemetry.vehicle_status = 0
            update_telemetry.patient_status = 0
            update_telemetry.message_flag = 0
            update_telemetry.message_lat = 33.933097
            update_telemetry.message_lon = -117.631055

    # ugv data

            update_telemetry.current_latitude = sample.latitude
            update_telemetry.current_longitude = sample.longitude
            update_telemetry.yaw = sample.heading_error
            update_telemetry.batter_life = 100.0
