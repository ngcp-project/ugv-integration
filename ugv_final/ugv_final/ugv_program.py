...
from ugv_publisher import loggerPublisher
from ugv_subscriber import loggerSubscriber
...
def main():
    ...
    if args.pub:
        print(f"Running loggerPublisher on domain {args.domain}")
        loggerPublisher.run_publisher(
            domain_id=args.domain,
            sample_count=args.sample_count)
    else:
        print(f"Running loggerSubscriber on domain {args.domain}")
